  ...
  return (
    <AnimatedSection>
      <section className="relative overflow-hidden bg-white px-6 py-16">
        {/* Декорации — голубки в верхних углах */}
        ...
        <div className="relative z-10 mx-auto max-w-xl text-center">
          ...
          {/* Адрес */}
          <p className="font-cormorant italic font-semibold mt-4 text-2xl leading-8 text-[#b8922e]">
          ...
          {/* Название */}
          <p className="font-cormorant italic mt-4 text-2xl font-semibold text-[#b8922e]">
            «{eventData.venue.name}» тойханасында
          </p>

          {/* Приглашение */}
          <p className="font-cormorant italic font-light mt-4 text-xl leading-9 text-[#1f1f1f]">
            өтетін қызымыздың ұзату тойына
            <br />
      ...
      <style>{`
        ...
        /* Голубки — плавное парение вверх-вниз с лёгким покачиванием */
        @keyframes doveFloat {
          0%, 100% {
        ...
        /* Бабочки — порхание: движение + взмах крыльями */
        ...
        /* Цветы — лёгкое покачивание, как на ветру */
